...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left dont-print" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="manage-anay.php" class="w3-bar-item w3-button w3-padding <?= $url == '/manage-anay.php' || str_contains($url, '/edit-anay.php') ? $active : '' ?>"><i class="fa fa-eye fa-fw" style="color: #c6322d !important;"></i> Manage Anay Pigs</a>
